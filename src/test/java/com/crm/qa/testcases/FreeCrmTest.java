...
public class FreeCrmTest {
	...
	public void setUp() throws Exception {
		System.setProperty("webdriver.chrome.driver", "/Users/ShyamBiradar/Downloads/chromedriver");
	...
	public static void getRunTimeInfoMessage(String messageType, String message) throws InterruptedException {
		...
		// js.executeScript("$.getScript('/Users/ShyamBiradar/Documents/workspace/Test/src/testcases/jquery.growl.js')");
...
//		js.executeScript("$.growl.warning({ title: 'Warning!', message: 'your warning message goes here' });");
	...
	public static void takeScreenshot(String fileName) throws IOException{
		...
		FileUtils.copyFile(src, 
				new File("/Users/ShyamBiradar/Documents/MyPOMFramework/PageObjectModel/screenshots/" + fileName +".png"));
